...
[![CI](https://github.com/ltmoerdani/mimo-copilot-chat/actions/workflows/ci.yml/badge.svg)](https://github.com/ltmoerdani/mimo-copilot-chat/actions/workflows/ci.yml)
[![Stars](https://img.shields.io/github/stars/ltmoerdani/mimo-copilot-chat?style=social)](https://github.com/ltmoerdani/mimo-copilot-chat/stargazers)
[![Issues](https://img.shields.io/github/issues/ltmoerdani/mimo-copilot-chat)](https://github.com/ltmoerdani/mimo-copilot-chat/issues)
[![Last Commit](https://img.shields.io/github/last-commit/ltmoerdani/mimo-copilot-chat)](https://github.com/ltmoerdani/mimo-copilot-chat/commits/main)

---

## 💡 What Is This?

**MiMo Copilot Chat** is a free, open-source VS Code extension that brings [Xiaomi MiMo](https://xiaomimimo.com) AI models into **GitHub Copilot Chat** via the official VS Code *Language Model Chat Provider API*.

### Why MiMo Copilot Chat?
...
|---|---|---|---|
| `mimo-copilot-chat.temperature` | `number` | `0.2` | Sampling temperature for chat completions (`0`–`2`) |
| `mimo-copilot-chat.maxTokens` | `number` | `0` | Max output token override — `0` uses the per-model bundled maximum |
| `mimo-copilot-chat.maxInputTokens` | `number` | `0` | Context window override — `0` uses the per-model bundled context size |
| `mimo-copilot-chat.requestTimeoutSeconds` | `number` | `600` | Total request timeout for MiMo API calls |
| `mimo-copilot-chat.streamIdleTimeoutSeconds` | `number` | `120` | Cancels a request if the response stream stops sending chunks for too long |
| `mimo-copilot-chat.showUsageStatusBar` | `boolean` | `true` | Show the latest MiMo usage summary in the VS Code status bar |
...
[![Star History Chart](https://api.star-history.com/svg?repos=ltmoerdani/mimo-copilot-chat&type=Date)](https://star-history.com/#ltmoerdani/mimo-copilot-chat&Date)
