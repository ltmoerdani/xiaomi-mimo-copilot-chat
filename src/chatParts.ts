...
export const MIMO_USAGE_DATA_MIME = "application/vnd.mimo.usage+json";
...
export function createUsageDataParts(
  ...
  return [
    ...
    new vscode.LanguageModelDataPart(data, MIMO_USAGE_DATA_MIME),
  ];
}
...
export function isInternalDataPart(
  ...
  return part.mimeType === MIMO_USAGE_DATA_MIME
